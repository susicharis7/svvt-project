...
class StandardCheckoutProcessTest extends BaseTest{
    ...
    /*  * Test Scenario - Standard Checkout Process - Purchase After Adding Product to Cart
        * + Test Case 1 - Successful checkout with valid data (Mock Credentials) - Radi 100%
        * + Test Case 2 - Submit Checkouts without accepting terms (Checkbox) - Radi 100%
        * + Test Case 3 - Submit checkout with invalid email format - Radi 100%
        * + Test Case 4 - Submit checkout with excessive product quantity - Radi 100%
        * + Test Case 5 - Checkout with empty cart (Flow Protection) (Expected : Redirekcija, Error Message) - Radi 100%
        * + Test Case 6 - Very Long Input (Boundary Testing)
    */


    // Test Case 1 - Successful Checkout with Valid Data
    @Test
    ...
    // Test Case 2 - Submit Checkouts without accepting terms (Checkbox)
    @Test
    ...
    // Test Case 3 - Submit checkout with invalid email format
    @Test
    ...
    // Test Case 4 - Add to Cart with Excessive Product Quantity
    @Test
    ...
    // Test Case 5 - Checkout without any items in the Cart
    @Test
