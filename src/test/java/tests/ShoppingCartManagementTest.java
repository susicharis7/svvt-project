...
class ShoppingCartManagementTest extends BaseTest {
    ...
    /* Test Scenario - Shopping Cart Management
     * Test Case 1 - Add single product to cart
     * Test Case 2 - Add multiple different products to cart
     ...
     * Test Case 6 - Cart Badge Updates Correctly
     */
    ...
    void cartBadgeUpdatesCorrectlyTest() throws InterruptedException {
        ...
        // Assert that Cart now has 1 product
        ...
        // Assert that Cart now has 2 products
        ...
        // Assert that Cart now has 1 product again
